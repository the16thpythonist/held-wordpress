...
Donate link: https://dion-designs.com/contribute
...
UsageDD will be compatible with every theme and plugin that outputs HTML.
...
= 1.4.6 =
Minor bug fixes and improved CSS.

= 1.4.5 =
Major improvements to usage display.
...
= 1.3 =
Usage display now compatible with the theme customizer.
